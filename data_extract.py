...
#rec_ = 'o01'
#rec = 'f1' + rec_
#dir = "/home/adrian.perez/Documents/just-experiments/breathing/"+rec+"/"
dir = "D:/Programs/Workspaces/spyder-workspace/just-experiments/breathing/"+rec+"/"
file_path = dir + rec
...
save = True
if save:
    np.save('time_warp.npy', data_full)
    np.save('breath.npy', databreath[:len(data_full)])
    np.save('breath_single.npy', np.stack([single, single_time]).T)